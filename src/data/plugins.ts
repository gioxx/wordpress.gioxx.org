...
export const plugins: Plugin[] = [
  ...
  },
  {
    ...
    features: {
      ...
      it: [
        "Analisi in batch di tutti i tag tramite l'AI Client di WordPress core, con log di elaborazione in tempo reale, avanzamento e pulsante di stop.",
        "Funziona con qualsiasi provider configurato in core (Anthropic, OpenAI, Google, ...); nessuna API key memorizzata dal plugin.",
        ...
        "Una scheda 'Manage Tags' per la manutenzione non-IA: istogramma d'uso, tabella tag ricercabile/ordinabile/paginata, eliminazione singola o bulk e uno strumento di unione manuale.",
        "Rilevazione tag non utilizzati (0 articoli) con eliminazione bulk e uno strumento per ricalcolare i conteggi disallineati.",
        "Preferenza di modello opzionale, dimensione batch e lingua delle risposte configurabili per il testo dei suggerimenti.",
        "Compatibile con Git Updater per aggiornamenti diretti da GitHub.",
      ],
    },
    install: [
